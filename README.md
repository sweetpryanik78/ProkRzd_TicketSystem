...
String for cron (auto update cert) ---> */5 * * * * docker compose --project-directory ~/ProkRzd_TicketSystem/ stop osticket && docker compose --project-directory ~/ProkRzd_TicketSystem/ start osticket
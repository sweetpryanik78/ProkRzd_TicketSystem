...
certbot certonly --standalone -d $DOMAIN_URL --register-unsafely-without-email --cert-name=certfolder --key-type ecdsa --agree-tos --disable-renew-updates --no-autorenew --non-interactive
